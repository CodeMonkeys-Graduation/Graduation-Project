...
public class TurnMgr_WaitMultipleEvents_ : TurnMgr_State_
{
    ...
    public TurnMgr_WaitMultipleEvents_(TurnMgr owner, Unit unit, List<Event> events,
        TurnMgr_State_ nextState, Action onWaitEnter = null, Action onWaitExecute = null, Action onWaitExit = null) : base(owner, unit)
    {
        this.events = events;
